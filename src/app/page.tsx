...
export default function Home() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const validUser = username.toLowerCase() === 'indra' || username.toLowerCase() === 'nadia';
    const validPass = password === 'innad' || password === 'nadin';

    // 2. Memperbaiki logika kurung OR (||) dan AND (&&) agar tidak bocor
